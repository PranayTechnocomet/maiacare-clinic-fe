        ...
        <Dropdown.Menu className="dots-open">
          <Dropdown.Item className="no-hover">
            <div className="d-flex align-items-center gap-2">
              ...
              <span className="settings-accordion-subtitle m-0" onClick={() => { setRescheduleModal(true); setDoctorListingModal(false); }}>Reschedule</span>
            </div>
          </Dropdown.Item>
          <Dropdown.Item className="no-hover">
            <div className="d-flex align-items-center gap-2 ">
              ...
              <span className="appoiment-dots-open-danger m-0" onClick={() => { setCancelModal(true); setDoctorListingModal(false); }}>Cancel Appointment</span>
            </div>
          </Dropdown.Item>
        </Dropdown.Menu>
      </Dropdown>
