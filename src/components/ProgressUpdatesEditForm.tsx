...
import { MedicationPrescriptionType, ProgressUpdatesType } from "../utlis/types/interfaces";
        ...
        <>
            ...
            {step == 2 && (
                <>
                    ...
                    {progressUpdatesData?.medicalPrescription?.length > 0 && medicalPrescriptionDataShowHide == false && (
                        <>
