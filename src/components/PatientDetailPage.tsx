    ...
    <>
      <div className="row mb-4">
        <div className="col-md-6">
          <h6 className="fw-semibold mb-3 mt-2 Patient-Details">
            Patient Details
          </h6>
        ...
        <div className="col-md-6">
          <h6 className="fw-semibold mb-3 mt-2 Patient-Details">
            Consultation Type and Concerns
          </h6>
          <ContentContainer className="shadow-sm border-0 patient-box">
            <Card.Body>
              <div className="mb-3">
              ...
              <div className="mt-1 mb-3">
                <strong className=" d-block mb-1 heading-patient">
                  Concerns:
                </strong>
                <p className=" mb-0 Patient-review">
                  Mild endometriosis and irregular periods has been an issue for
                  2 months.
                </p>
                <p className=" mb-0 Patient-review">
      ...
      <div className="mt-1">
        ...
        />
        {activeTab === "basic" && (
          <div className="mt-4 mb-5">ProfileBasicDetails</div>
        )}

        {activeTab === "Details" && (
          <div className="mt-4 mb-5">ProfileManageLeave</div>
        )}
      </div>
    </>
  );
