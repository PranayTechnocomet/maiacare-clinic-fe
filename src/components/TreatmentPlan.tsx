...
// import "../style/settingPassword.css";
...
import { MedicationPrescriptionType, TreatmentPlanFormData } from "../utlis/types/interfaces";
                                    ...
                                    return (
                                        <Accordion.Item eventKey={index.toString()} className='medication-prescription-accordion-item-main mb-3 shadow-sm' key={index}>
                                            ...
                                            <Accordion.Body className='pt-0'>
                                                ...
                                                <Button className='mt-3' variant="outline" disabled={false} contentSize="small" onClick={() => { setEditForm(item); setShowEditFormShowModel(true); setTreatmentPlanModel(false); setMedicalPrescriptionDataShowHide(true);
                                                 }}>
