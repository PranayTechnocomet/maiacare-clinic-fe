...
import { TreatmentPatientForm } from "../components/form/TreatmentAllForm"
import { useState } from "react";
import { MedicationPrescriptionType } from "../utlis/types/interfaces";
import { FollowUpActionForm, MedicationPrescriptionForm } from "./form/TreatmentPlanForm";
...
export function TreatmentForm({
    ...
    return (
        <>
            ...
            {step == 2 && (
                <>
                    <h6 className="dashboard-chart-heading pb-2">Medication Prescription</h6>

                    {medicalPrescription.length > 0 && medicalPrescriptionDataShowHide == false && (
                        <>
                                    ...
                                    return (
                                        <Accordion.Item eventKey={index.toString()} className='medication-prescription-accordion-item-main mb-3 shadow-sm' key={index}>
                                            ...
                                            <Accordion.Body className='pt-0'>
                                                ...
                                                <Button className='mt-3' variant="outline" disabled={false} contentSize="small" onClick={() => { setEditForm(item); setShowEditFormShowModel(true); setTreatmentPlanModel(false); setMedicalPrescriptionDataShowHide(true); console.log("click");
                                                 }}>
