...
import { TreatmentPlanEditForm } from "./form/TreatmentAllForm"
import { FollowUpActionForm, MedicationPrescriptionForm } from "./form/TreatmentPlanForm";
import { EditTreatmentPlanType, MedicationPrescriptionType } from "../utlis/types/interfaces";
        ...
        <>
            ...
            {step == 2 && (
                <>
                    ...
                    {editTreatmentData?.medicalPrescription?.length > 0 && medicalPrescriptionDataShowHide == false && (
                        <>
                            <Accordion defaultActiveKey="0">
                                {editTreatmentData?.medicalPrescription?.map((item, index) => {
                                    return (
                    ...
                    <MedicationPrescriptionForm
                        ...
                        medicalPrescription={editTreatmentData?.medicalPrescription}
