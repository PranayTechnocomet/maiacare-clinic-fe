...
import patient from "../assets/images/doctor2.png";
import {
  FertilityAssessment,
  MedicalHistoryForm,
  PhysicalAssessment,
...
import {
  ...
  FertilityAssessmentPartnerShow,
...
export default function PartnerDetail({
  ...
  const [editFertilityAssessmentPartner, setEditFertilityAssessmentPartner] =
    useState<FertilityAssessmentPartnerShow | null>(null);
  ...
  const validateForm2 = (
    ...
    if (data.surgeries === "yes" && !data.surgeriesDetails.trim())
      errors.surgeriesDetails = "Surgeries Content is required";

    return errors;
  };

  useEffect(() => {
    if (!editFertilityAssessmentPartner) return;

    setFormDataEditFertilityAssessment({
      semenAnalysis:
        editFertilityAssessmentPartner.semenAnalysis?.status || "Yes",
      semenAnalysisDetails:
        editFertilityAssessmentPartner.semenAnalysis?.semenAnalysisDetails ||
        "",

      fertilityIssues:
        editFertilityAssessmentPartner.fertilityIssues?.status || "No",
      fertilityIssuesDetails:
        editFertilityAssessmentPartner.fertilityIssues
          ?.fertilityIssuesDetails || "",

      fertilityTreatment:
        editFertilityAssessmentPartner.fertilityTreatments?.status || "No",
      fertilityTreatmentsDetails:
        editFertilityAssessmentPartner.fertilityTreatments
          ?.fertilityTreatmentsDetails || "",

      surgeries: editFertilityAssessmentPartner.surgeries?.status || "No",
      surgeriesDetails:
        editFertilityAssessmentPartner.surgeries?.surgeriesDetails || "",
    });
  }, [editFertilityAssessmentPartner]);
  ...
  const handleAddPhysicalAssessment = (
    ...
    if (Object.keys(errors).length === 0) {
      ...
      const updatedFormData = {
        ...formDataAddPhysicalAssessment,
        patientId,
        height: Number(formDataAddPhysicalAssessment.height),
        weight: Number(formDataAddPhysicalAssessment.weight),
        bmi: Number(formDataAddPhysicalAssessment.bmi),
        heartRate: Number(formDataAddPhysicalAssessment.heartRate),
        bloodPressureSystolic: Number(
          formDataAddPhysicalAssessment.bloodPressureSystolic
        ),
        bloodPressureDiastolic: Number(
          formDataAddPhysicalAssessment.bloodPressureDiastolic
        ),
      };
  ...
  const handleEditFertilityAssessment = (
    e: React.FormEvent<HTMLFormElement> | React.MouseEvent<HTMLButtonElement>
  ) => {
    e.preventDefault();
    ...
    if (Object.keys(errors).length === 0) {
      const updatedFormData = {
        ...
        semenAnalysis: {
          ...
          semenAnalysisDetails:
            formDataEditFertilityAssessment.semenAnalysisDetails,
        },

        fertilityIssues: {
          status: formDataEditFertilityAssessment.fertilityIssues,
          fertilityIssuesDetails:
            formDataEditFertilityAssessment.fertilityIssuesDetails,
        },

        fertilityTreatments: {
          status: formDataEditFertilityAssessment.fertilityTreatment,
          fertilityTreatmentsDetails:
            formDataEditFertilityAssessment.fertilityTreatmentsDetails,
        },

        surgeries: {
          status: formDataEditFertilityAssessment.surgeries,
          surgeriesDetails: formDataEditFertilityAssessment.surgeriesDetails,
        },
      };
      ...
      {showData === null ? (
        <>
          <Row className="mt-2 g-3">
            <Col md={7}>
              {/* partner basic details Skeletone ui */}
              <ContentContainer>
                <div className="d-flex justify-content-between align-items-start">
                  <div className="d-flex align-items-start align-items-sm-center gap-3 flex-column flex-sm-row">
                    ...
                    <div>
                      ...
                      <div className="pt-sm-1 p-0 d-flex gap-3 flex-wrap">
                      ...
                      <div className="pt-sm-1 p-0 d-flex flex-wrap gap-3">
                        <div className="d-flex justify-content-center align-items-center gap-1">
                          <Skeleton width={20} height={20} borderRadius={4} />
              ...
              {/* partner Medical History Skeletone ui */}
              <ContentContainer className="mt-3">
                ...
                <Row>
                  ...
                  <Col sm={5}>
                    <div className="mt-3">
                      <Skeleton width={160} height={18} /> {/* Title */}
                  ...
                  <Col sm={7}>
                    <div className="mt-3">
                      <Skeleton width={140} height={18} /> {/* Title */}
                  ...
                  <Col sm={12}>
                    <div className="mt-3">
                      <Skeleton width={200} height={18} /> {/* Title */}
                  ...
                  <Col sm={7}>
                    <div className="mt-3">
                      <Skeleton width={100} height={18} /> {/* Title */}
                      <div className="d-flex flex-wrap gap-2 mt-2">
                        {[1, 2, 3, 4].map((i) => (
                          <Skeleton
                            key={i}
            ...
            <Col md={5}>
              {/* partner Physical Assessment Skeletone ui */}
              <ContentContainer className="mt-3">
                {/* Header Section */}
                <div className="d-flex justify-content-between align-items-center">
                  <Skeleton width={150} height={24} />{" "}
              ...
              {/* partner Fertility Assessment Skeletone ui */}
              <ContentContainer className="mt-3">
                  ...
                  <Row>
                    ...
                    <Col md={6} sm={6}>
                      <div className="mb-3">
                        ...
                        <Skeleton width={230} height={16} className="mb-1" />
                      </div>
                    </Col>
                    ...
                    <Col md={6} sm={6}>
                      <div className="mb-3">
                        <Skeleton width={170} height={18} className="mb-2" />
        ...
        <Row className="mt-2 g-3">
          <Col md={7}>
            ...
            {/* when any secation edit and new add show Skeletone ui */}
                ...
                <div className="d-flex align-items-start align-items-sm-center gap-3 flex-column flex-sm-row">
                  <div>
                    ...
                    <Image
                      src={patient}
                      // {
                      //   typeof showData?.basicDetails?.partnerImage === "string"
                      //     ? showData.basicDetails.partnerImage
                      //     : Simpleeditpro.src
                      // }
                      alt="Partner Image"
                      width={90}
                  ...
                  <div>
                    <div className="d-flex align-items-center mb-1">
                      <h6 className="mb-0 doctor-profile-heading me-2">
                        {showData?.basicDetails?.partnerName}
                      </h6>
                    </div>
                    <div className="pt-sm-1 p-0 d-flex gap-2 ">
                      <div className="d-flex justify-content-center align-items-center gap-1">
                        ...
                        <span className="doctor-profile-subheading">
                          {showData?.basicDetails?.partnerGender}
                        </span>
                      </div>
                      <div className="d-flex justify-content-center align-items-center gap-1">
                        <svg
                        ...
                        <span className="doctor-profile-subheading">
                          {showData?.basicDetails?.partnerAge} Years
                        </span>
                      </div>
                    </div>
                    <div className="pt-sm-1 p-0 d-flex flex-wrap gap-2">
                      <div className="d-flex justify-content-center align-items-center gap-1">
                        ...
                        <span className="doctor-profile-subheading">
                          {`+91 ${String(
                            showData?.basicDetails?.partnerContactNumber
                          ).slice(-10)}`}
                        </span>
                      </div>
                      <div className="d-flex justify-content-center align-items-center gap-1">
              ...
              <Row className="">
                <Col sm={5}>
                  <div className="">
                    ...
                    <p className=" accordion-title-detail">
                      {showData?.medicalHistory?.medications?.status === "Yes"
                        ? showData?.medicalHistory?.medications
                ...
                <Col sm={7}>
                  <div className="">
                    ...
                    <p className=" accordion-title-detail">
                      {showData?.medicalHistory?.surgeries?.status === "Yes"
                        ? showData?.medicalHistory?.surgeries
                ...
                <Col sm={12}>
                  <div className="">
                    ...
                    {showData?.medicalHistory?.conditions.map(
                    ...
                    <div className=" accordion-title-detail">
                      <ul>
                        <li className="medical-emergency-fimily-history">
                          {showData?.medicalHistory?.familyHistory ||
                ...
                <Col sm={7}>
                  <div className="">
                    ...
                    {showData?.medicalHistory?.lifestyle?.map(
                      (item: any, index: number) => {
                        return (
                          <p
                            key={index}
          ...
          <Col md={5}>
            <ContentContainer>
              <div className="d-flex justify-content-between align-items-center">
                ...
                <span
                  className="medical-history-add-btn medical-history-edit-btn-font mb-3"
                  onClick={() => {
                          ...
                          <div className="phisical-assessment-accordion-showData-box d-flex gap-2">
                            ...
                            <div className="d-flex flex-column gap-1">
                              ...
                              <span className="phisical-assessment-accordion-showData-box-subtitle">
                                ...
                                {item.bloodPressure.diastolic} mmHg
                              </span>
                            </div>
                          </div>
                        </Col>
            ...
            <ContentContainer className="mt-3">
              <div className="medical-history-details text-start">
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <Button
                    variant="outline"
                    className="medical-history-edit-btn medical-history-edit-btn-font mb-3"
                    onClick={() => {
                      setEditFertilityAssessment(true);
                      setEditFertilityAssessmentPartner(
                ...
                <Row>
                  <Col md={6} sm={6}>
                    <div className="mb-3">
                      ...
                      <p className="mb-2 accordion-title-detail">
                        ...
                        "Yes"
                          ? showData?.fertilityAssessment?.semenAnalysis
                              ?.semenAnalysisDetails
                  ...
                  <Col md={6} sm={6}>
                    <div className="mb-3">
                      ...
                      <p className="mb-2 accordion-title-detail">
                        {showData?.fertilityAssessment?.fertilityIssues
                          .status === "Yes"
                          ? showData?.fertilityAssessment?.fertilityIssues
                              ?.fertilityIssuesDetails
                  ...
                  <Col md={6} sm={6}>
                    <div className="mb-3">
                      ...
                      <p className="mb-2 accordion-title-detail">
                        {showData?.fertilityAssessment?.fertilityTreatments
                          .status === "Yes"
                          ? showData?.fertilityAssessment?.fertilityTreatments
                              ?.fertilityTreatmentsDetails
                  ...
                  <Col md={6} sm={6}>
                    <div className="mb-3">
                      ...
                      <p className="mb-2 accordion-title-detail">
                        ...
                        "Yes"
                          ? showData?.fertilityAssessment?.surgeries
                              ?.surgeriesDetails
      ...
      >
        ...
        <div className="d-flex gap-3">
          ...
          <Button
            ...
            disabled={false}
            type="button"
            onClick={handleEditFertilityAssessment}
          >
            Save
          </Button>
        </div>
