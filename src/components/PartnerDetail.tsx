                  ...
                  <div>
                    <div className="d-flex align-items-center mb-1">
                      <h6 className="mb-0 doctor-profile-heading me-2">
                        {showData.profile.basic_detail_name}
                      </h6>
                    </div>
                    ...
                    <div className="pt-sm-1 p-0 d-flex gap-2 ">
                      <div className="d-flex justify-content-center align-items-center gap-1">
                        ...
                        <span className="doctor-profile-subheading">
                          {showData.profile.basic_detail_gender}
                        </span>
                      </div>
                      <div className="d-flex justify-content-center align-items-center gap-1">
                        <svg
                    ...
                    <div className="pt-sm-1 p-0 d-flex flex-wrap gap-2">
                      <div className="d-flex justify-content-center align-items-center gap-1">
                        ...
                        <span className="doctor-profile-subheading">
                          {showData.profile.basic_detail_phone}
                        </span>
                      </div>
                      <div className="d-flex justify-content-center align-items-center gap-1">
                        <svg
                        ...
                        <span className="doctor-profile-subheading">
                          {showData.profile.basic_detail_email}{" "}
                        </span>
                      </div>
                    </div>
                  </div>
          ...
          <Col md={5}>
            <ContentContainer>
              ...
              <Accordion defaultActiveKey="0">
                {showData.PhysicalAssessmentData?.map(
                  (item: PhysicalAssessmentItem, index: number) => (
                    <Accordion.Item
              ...
              {[
                {
                  ...
                  fertilityTreatment:
                    showData.fertilityAssessment.fertilityTreatment,
                  surgeries: showData.fertilityAssessment.surgeries,
                  semenAnalysisContent:
                    showData.fertilityAssessment.semenAnalysisContent,
                  fertilityIssuesContent:
                    showData.fertilityAssessment.fertilityIssuesContent,
                  fertilityTreatmentContent:
                    showData.fertilityAssessment.fertilityTreatmentContent,
                  surgeriesContent:
                    showData.fertilityAssessment.surgeriesContent,
                },
              ].map((item: FertilityAssessmentItem, index: number) => (
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        setFormDataEditFertilityAssessment({
                          ...item,
                          semenAnalysisContent: item.semenAnalysisContent ?? "",
                          fertilityIssuesContent:
                            item.fertilityIssuesContent ?? "",
                          fertilityTreatmentContent:
                            item.fertilityTreatmentContent ?? "",
                          surgeriesContent: item.surgeriesContent ?? "",
                        });
                      }}
                    >
                      <svg
        ...
        <div className="d-flex gap-3">
          ...
          <Button
            ...
            onClick={(e: React.MouseEvent<HTMLButtonElement>) =>
              handleEditFertilityAssessment(e)
            }
          >
            Save
          </Button>
