...
import { treatmentPlanData } from "../utlis/StaticData";
...
export function All() {
  ...
  const columns: ColumnDef<TreatmentPlanAllRow>[] = [
    {
      header: "#",
      cell: (info) => {
                    ...
                    <defs>
                      <clipPath id="clip0_2225_104662">
                        <rect
                          ...
                          height="40"
                          fill="white"
                          transform="translate(0.748169)"
                        />
                      </clipPath>
                    </defs>
                  </svg>
                  <p className="appointments-total-box-item m-0">
                    98 Appointments
                  </p>
                </div>
              </div>
...
export function IVF() {
  ...
  const columns: ColumnDef<TreatmentPlanIVFRow>[] = [
    {
      header: "#",
      cell: (info) => {
        const index = info.row.index + 1; // row number start from 1
    ...
    // {
    //   header: "step",
    //   cell: (info) => <span>{info.row.original.step}</span>,
    // },
        ...
        <Row className="g-3 mt-3">
          <Col md={3}>
            <div className="custom-side-bar-box">
              <Nav
                variant="pills"
                className="flex-column gap-2 custom-side-bar"
              >
