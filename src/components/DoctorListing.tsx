...
import { AppointmentRequestCancelModel } from "../components/TempAppoRequstCancelModel";
...
export default function DoctorListing() {
  ...
  useEffect(() => {
    dispatch(
      setHeaderData({ title: "Appointments", subtitle: "Appointments List" })
    );
  }, []);
...
export function CalendarView() {
  ...
  const [selectedPatient, setSelectedPatient] = useState<
    tempAppointmentProfileData | any
  >();
  ...
  const [selectedCard, setSelectedCard] = useState<
    "Upcoming" | "Waiting" | "Engaged" | "Done" | null
  >(null);
  const displayLimits: Record<
    "Upcoming" | "Waiting" | "Engaged" | "Done",
    number
  > = {
    Upcoming: 5,
    Waiting: 3,
        ...
        <div className="appointments-total-box d-flex align-items-center gap-2">
          ...
          >
            <g clipPath="url(#clip0_2202_83537)">
              ...
              />
              <path
                d="M31.0969 14.2754V29.6598C31.0969 29.9208 30.9932 30.1712 30.8086 30.3558C30.624 30.5404 30.3736 30.6441 30.1125 30.6441H8.48437C8.2233 30.6441 7.97292 30.5404 7.78832 30.3558C7.60371 30.1712 7.5 29.9208 7.5 29.6598V14.2754H31.0969Z"
                fill="white"
              />
              <path
                d="M27.5969 7.95312H26.4844C26.2134 7.95312 25.9938 8.17279 25.9938 8.44375V11.55C25.9938 11.821 26.2134 12.0406 26.4844 12.0406H27.5969C27.8679 12.0406 28.0875 11.821 28.0875 11.55V8.44375C28.0875 8.17279 27.8679 7.95312 27.5969 7.95312Z"
                fill="#292929"
              />
              <path
                d="M12.3562 7.95312H11.2437C10.9728 7.95312 10.7531 8.17279 10.7531 8.44375V11.55C10.7531 11.821 10.9728 12.0406 11.2437 12.0406H12.3562C12.6272 12.0406 12.8469 11.821 12.8469 11.55V8.44375C12.8469 8.17279 12.6272 7.95312 12.3562 7.95312Z"
                fill="#292929"
              />
              <path
                d="M11.9481 16.8252H10.2831C10.018 16.8252 9.8031 17.0401 9.8031 17.3052V18.9702C9.8031 19.2353 10.018 19.4502 10.2831 19.4502H11.9481C12.2132 19.4502 12.4281 19.2353 12.4281 18.9702V17.3052C12.4281 17.0401 12.2132 16.8252 11.9481 16.8252Z"
                fill="#FFD1A4"
              />
              <path
                d="M17.4044 16.8252H15.7394C15.4743 16.8252 15.2594 17.0401 15.2594 17.3052V18.9702C15.2594 19.2353 15.4743 19.4502 15.7394 19.4502H17.4044C17.6695 19.4502 17.8844 19.2353 17.8844 18.9702V17.3052C17.8844 17.0401 17.6695 16.8252 17.4044 16.8252Z"
                fill="#FFD1A4"
              />
              <path
                d="M22.8575 16.8252H21.1925C20.9274 16.8252 20.7125 17.0401 20.7125 17.3052V18.9702C20.7125 19.2353 20.9274 19.4502 21.1925 19.4502H22.8575C23.1226 19.4502 23.3375 19.2353 23.3375 18.9702V17.3052C23.3375 17.0401 23.1226 16.8252 22.8575 16.8252Z"
                fill="#FFD1A4"
              />
              <path
                d="M28.3138 16.8252H26.6488C26.3837 16.8252 26.1688 17.0401 26.1688 17.3052V18.9702C26.1688 19.2353 26.3837 19.4502 26.6488 19.4502H28.3138C28.5789 19.4502 28.7938 19.2353 28.7938 18.9702V17.3052C28.7938 17.0401 28.5789 16.8252 28.3138 16.8252Z"
                fill="#FFD1A4"
              />
              <path
                d="M11.9481 21.3848H10.2831C10.018 21.3848 9.8031 21.5997 9.8031 21.8648V23.5298C9.8031 23.7949 10.018 24.0098 10.2831 24.0098H11.9481C12.2132 24.0098 12.4281 23.7949 12.4281 23.5298V21.8648C12.4281 21.5997 12.2132 21.3848 11.9481 21.3848Z"
                fill="#FFD1A4"
              />
              <path
                d="M17.4044 21.3848H15.7394C15.4743 21.3848 15.2594 21.5997 15.2594 21.8648V23.5298C15.2594 23.7949 15.4743 24.0098 15.7394 24.0098H17.4044C17.6695 24.0098 17.8844 23.7949 17.8844 23.5298V21.8648C17.8844 21.5997 17.6695 21.3848 17.4044 21.3848Z"
                fill="#FFD1A4"
              />
              <path
                d="M22.8575 21.3848H21.1925C20.9274 21.3848 20.7125 21.5997 20.7125 21.8648V23.5298C20.7125 23.7949 20.9274 24.0098 21.1925 24.0098H22.8575C23.1226 24.0098 23.3375 23.7949 23.3375 23.5298V21.8648C23.3375 21.5997 23.1226 21.3848 22.8575 21.3848Z"
                fill="#FFD1A4"
              />
              <path
                d="M28.3138 21.3848H26.6488C26.3837 21.3848 26.1688 21.5997 26.1688 21.8648V23.5298C26.1688 23.7949 26.3837 24.0098 26.6488 24.0098H28.3138C28.5789 24.0098 28.7938 23.7949 28.7938 23.5298V21.8648C28.7938 21.5997 28.5789 21.3848 28.3138 21.3848Z"
                fill="#FFD1A4"
              />
              <path
                d="M11.9481 25.9404H10.2831C10.018 25.9404 9.8031 26.1553 9.8031 26.4204V28.0854C9.8031 28.3505 10.018 28.5654 10.2831 28.5654H11.9481C12.2132 28.5654 12.4281 28.3505 12.4281 28.0854V26.4204C12.4281 26.1553 12.2132 25.9404 11.9481 25.9404Z"
                fill="#FFD1A4"
              />
              <path
                d="M17.4044 25.9404H15.7394C15.4743 25.9404 15.2594 26.1553 15.2594 26.4204V28.0854C15.2594 28.3505 15.4743 28.5654 15.7394 28.5654H17.4044C17.6695 28.5654 17.8844 28.3505 17.8844 28.0854V26.4204C17.8844 26.1553 17.6695 25.9404 17.4044 25.9404Z"
                fill="#FFD1A4"
              />
              <path
                d="M22.8575 25.9404H21.1925C20.9274 25.9404 20.7125 26.1553 20.7125 26.4204V28.0854C20.7125 28.3505 20.9274 28.5654 21.1925 28.5654H22.8575C23.1226 28.5654 23.3375 28.3505 23.3375 28.0854V26.4204C23.3375 26.1553 23.1226 25.9404 22.8575 25.9404Z"
                fill="#FFD1A4"
              />
              <path
              ...
              />
              <path
                d="M28.5219 30.3691L27.45 29.2941L27.8688 28.8754L28.5219 29.5285L30.7281 27.3223L31.1469 27.741L28.5219 30.3691Z"
                fill="#EEEFEE"
              />
            </g>
            <defs>
          ...
          <div className="custom-date-calendar calendar-box">
              ...
              <div className="d-flex align-items-center justify-content-center ">
                <div className=" w-100 calender-card-main">
                  <Stack direction="horizontal" className="mb-0 p-3 ">
                    ...
                    <div
                      className={`ms-auto d-flex align-items-center dropdown-toggle-icon ${
                        isOpen ? "open" : ""
                      }`}
                      role="button"
            ...
            <div className="p-3 ">
              <div className="d-flex justify-content-between align-items-center mb-2">
                ...
                <p
                  className="mb-0 doctor-listing-calender-filter "
                  onClick={clearAll}
                >
                  Clear all
                </p>
              ...
              <div className="mt-3">
                {selectedView === "day" && (
                  <div>
                    ...
                    <p className="doctor-listing-date-subtitle">
                      10 Appointments
                    </p>
                  </div>
                )}
                ...
                >
                  <Nav.Item>
                    <Nav.Link
                      ...
                      className={
                        (selectedView === "day"
                          ? "doctor-listing-day-week-month"
                          : "") || "doctor-listing-day-custom-active111 "
                      }
                    >
                      Day
                    </Nav.Link>
              ...
              header={
                <>
                  <div className="d-flex gap-3">
                    <p className="doctor-listing-modal-label">
                      # Appointment Id{" "}
                      <span className="doctor-listing-modal-id">
                        {selectedPatient?.appointment_id}
                      </span>
                    </p>
                    <p className="doctor-listing-modal-main-title">
                      {" "}
                      <svg
                        className="me-1"
                        width="15"
            ...
            >
              <>
                <div>
                  <div className="doctor-listing-modal-profile">
                    <div className="d-flex justify-content-between">
                      <div className="d-flex gap-2">
                        <Image
                          src={selectedPatient?.patient_profile}
                          alt="doctor"
                          className="doctor-listing-modal-profile-img"
                          width={46}
                          height={46}
                        />
                        <div className="d-flex flex-column gap-2">
                          <div className="d-flex gap-4">
                            <p className="doctor-listing-modal-profile-title m-0">
                              {selectedPatient?.patient_name}
                            </p>
                            <p className="doctor-listing-modal-profile-subtitle m-0">
                              {selectedPatient?.patient_status}
                            </p>
                          </div>
                          <div className="d-flex gap-4">
                            <p className="m-0 doctor-listing-modal-label">
                              {" "}
                              <svg
                                width="14"
                                height="13"
                  ...
                  <div className="mt-3">
                    <p className="mb-2 doctor-listing-modal-label ">
                      <svg
                        width="14"
                        className="me-1"
                        height="13"
                    ...
                    <div className="d-flex justify-content-between">
                      <p className="m-0 doctor-listing-modal-subtext ">
                        {" "}
                        <svg
                          width="14"
                          className="me-1"
                    ...
                    <div>
                      ...
                      <div className="d-flex gap-1">
                        <p className="m-0 doctor-listing-modal-orange-box">
                          Fertility Support{" "}
                        </p>
                        <p className="m-0 doctor-listing-modal-orange-box">
                          IVF
                    ...
                    <div className="d-flex gap-3">
                      <p className="mb-2 doctor-listing-modal-label m-0 ">
                        <svg
                          width="16"
                          height="10"
                          className="me-1"
                      ...
                      <p className=" m-0 doctor-listing-payment-unpaid">
                        {selectedPatient?.patient_payment}
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="doctor-listing-aditional-commit">
                        {selectedPatient?.patient_additional_commet}
                      </p>
                    </div>
                    ...
                    <div className="doctor-listing-modal-buttons d-flex gap-2 ">
                      <Button
                        variant="outline"
                        disabled={false}
                        onClick={() => setDoctorListingModal(false)}
                        className="w-100"
                      >
                        No Show
                      </Button>
                ...
                <>
                  <div className="min-vh-100 d-flex align-items-center justify-content-center day-formate-wrapper">
                    <div className="w-100 bg-white shadow-lg d-flex day-calender-mian-card">
                      ...
                      <div
                        className={`border-end d-flex flex-column timeColumn-days-colum`}
                      >
                        {/* Header with Icon */}
                        <div className="d-flex align-items-center justify-content-center border-bottom header-icon-day">
                          <svg
                            ...
                            viewBox="0 0 24"
                            xmlns="http://www.w3.org/2000/svg"
                            className="header-icon-day-color"
                          >
                            <path
                              strokeLinecap="round"
                      ...
                      <div className="flex-grow-1 d-flex flex-column">
                        ...
                        <div className="d-flex align-items-center border-bottom p-3 day-date-header">
                          <div className="d-flex flex-column ">
                            <p className=" mb-0 me-2 day-formate-text">
                              {dayDateFormat}
                            </p>
                            {selectedDate && (
                          ...
                          >
                            {timeSlots.map((slot, slotIndex) => {
                              const slotAppointments =
                                CalnderAppointments.filter((appt: any) => {
                                  const currentSlotMinutes = toMinutes(
                                    slot.time
                                  );
                                  const nextSlot = timeSlots[slotIndex + 1];
                                  const nextSlotMinutes = nextSlot
                                    ? toMinutes(nextSlot.time)
                                    : currentSlotMinutes + 30;

                                  const apptMinutes = toMinutesFromJson(
                                    appt.time
                                  );
                                  return (
                                    apptMinutes >= currentSlotMinutes &&
                                    apptMinutes < nextSlotMinutes
                                  );
                                });
                                        ...
                                        return (
                                          ...
                                          >
                                            <div className="appointment-box d-flex align-items-center gap-3">
                                              <div
                                                className="d-flex position-relative cursor-pointer-custom"
                                                onClick={() => {
                                                  setMultiPatientShow(true);
                                                }}
                                              >
                                                <Image
                                                  src={
            ...
            <Col md={4}>
              <div className="todays-schedule-main mt-3  ">
                <div className="today-schedule">
                  <p className="doctor-listing-heading mb-0 ">
                    Today’s Schedule
                  </p>
                </div>
                ...
                <div className="today-schedule-box-section ">
                  <div className="d-flex justify-content-between align-items-center gap-2 p-0">
                    <div
                      className={`doctor-listing-today-schedule-box d-flex flex-column align-items-center ${
                        selectedCard === "Upcoming"
                          ? "today-schedule-box-color"
                          : ""
                      }`}
                      onClick={() => setSelectedCard("Upcoming")}
                    >
                      <p className="doctor-listing-today-schedule-boxs text-center">
                        Upcoming
                      </p>
                      <div
                    ...
                    >
                      ...
                      <div
                        ...
                        style={
                          selectedCard === "Waiting" ? { color: "#fff" } : {}
                        }
                      >
                        3
                      </div>
                    ...
                    >
                      ...
                      <div
                        className={`done-box doctor-listing-all-box ${
                          selectedCard === "Done" ? "today-shedule-color" : ""
                        }`}
                      >
                        4
                      </div>
                  ...
                  {(selectedCard
                    ? doctorlistingModalData.slice(
                        0,
                        displayLimits[selectedCard]
                      )
                    : doctorlistingModalData
                      ...
                      <div className="docotor-listing-today-schedule-datas">
                        <Card className="d-flex flex-row align-items-center p-2 shadow-sm rounded-3 border-0 selected-calender-data">
                          ...
                          <div className="flex-grow-1">
                            <p className="doctor-listing-modal-patient-name m-0">
                              {item.patient_name}
                            </p>
