...
import { FertilityAssessmentForm } from "../components/form/FertilityAssessmentForm";
import PhisicalAssessmentForm from "../components/form/PhisicalAssessmentForm";
import { journeyData, MedicalHistoryData } from "../utlis/StaticData";
...
import { physicalAssessmentData } from "../utlis/StaticData";
...
const contactData = {
  ...
  address:
    "Opp Olympia Coffee House, Shahid Bhagat Singh Road, Colaba Causeway, Mumbai 400001, Maharashtra",
  emergencyContact: {
    name: "Raj Desai",
...
const ProfileBasicDetail = () => {
  ...
  const [showFertilityAssessment, setShowFertilityAssessment] =
    useState<boolean>(false);

  const [showModal, setShowModal] = useState<boolean>(false);
  const [medicalHistoryFormData, setMedicalHistoryFormData] = useState<
    MedicalHistoryType | any
  >([]);
  ...
  const [modalFormPhisicalData, setModalFormPhisicalData] = useState<
    PhysicalAssessmentDataModel[]
  >([]);
  const [modalFormFertilityData, setModalFormFertilityData] = useState<
    FertilityAssessmentFormType | any
  >([]);
        ...
        <>
          {modalFormPhisicalData.length === 0 ? (
            <div className="text-center">
              ...
              >
                <g clipPath="url(#clip0_3886_2587)">
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M17.6439 4.10156C18.1236 4.10156 18.5143 4.49044 18.5143 4.97191C18.5143 5.45153 18.1254 5.84226 17.6439 5.84226H14.9292C14.4496 5.84226 14.0588 5.45338 14.0588 4.97191C14.0588 4.49229 14.4477 4.10156 14.9292 4.10156H17.6439ZM17.6439 8.75701C18.1236 8.75701 18.5143 9.14589 18.5143 9.62736C18.5143 10.107 18.1254 10.4977 17.6439 10.4977H14.9292C14.4496 10.4977 14.0588 10.1088 14.0588 9.62736C14.0588 9.14774 14.4477 8.75701 14.9292 8.75701H17.6439ZM17.6439 13.4125C18.1236 13.4125 18.5143 13.8013 18.5143 14.2828C18.5143 14.7643 18.1254 15.1532 17.6439 15.1532H14.9292C14.4496 15.1532 14.0588 14.7643 14.0588 14.2828C14.0588 13.8013 14.4477 13.4125 14.9292 13.4125H17.6439ZM17.6439 18.0679C18.1236 18.0679 18.5143 18.4568 18.5143 18.9383C18.5143 19.4179 18.1254 19.8086 17.6439 19.8086H14.9292C14.4496 19.8086 14.0588 19.4197 14.0588 18.9383C14.0588 18.4586 14.4477 18.0679 14.9292 18.0679H17.6439ZM17.6439 22.7234C18.1236 22.7234 18.5143 23.1122 18.5143 23.5937C18.5143 24.0733 18.1254 24.4641 17.6439 24.4641H14.9292C14.4496 24.4641 14.0588 24.0752 14.0588 23.5937C14.0588 23.1141 14.4477 22.7234 14.9292 22.7234H17.6439ZM17.6439 27.3788C18.1236 27.3788 18.5143 27.7677 18.5143 28.2492C18.5143 28.7288 18.1254 29.1195 17.6439 29.1195H14.9292C14.4496 29.1195 14.0588 28.7306 14.0588 28.2492C14.0588 27.7695 14.4477 27.3788 14.9292 27.3788H17.6439ZM17.6439 32.0342C18.1236 32.0342 18.5143 32.4231 18.5143 32.9046C18.5143 33.3842 18.1254 33.7749 17.6439 33.7749H14.9292C14.4496 33.7749 14.0588 33.3861 14.0588 32.9046C14.0588 32.425 14.4477 32.0342 14.9292 32.0342H17

                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M32.5861 73.1445H34.4565C35.275 73.1445 36.0175 73.4779 36.5564 74.0167C37.0953 74.5556 37.4286 75.2982 37.4286 76.1167V78.237C37.4286 78.7074 37.0471 79.087 36.5786 79.087H30.4677C29.9973 79.087 29.6177 78.7055 29.6177 78.237V76.1167C29.6177 75.2982 29.951 74.5556 30.4899 74.0167C31.0251 73.4779 31.7676 73.1445 32.5861 73.1445ZM42.3822 73.1445H44.2525C45.071 73.1445 45.8136 73.4779 46.3525 74.0167C46.8914 74.5556 47.2247 75.2982 47.2247 76.1167V78.237C47.2247 78.7074 46.8432 79.087 46.3747 79.087H40.2637C39.7934 79.087 39.4137 78.7055 39.4137 78.237V76.1167C39.4137 75.2982 39.7471 74.5556 40.2859 74.0167C40.8211 73.4779 41.5637 73.1445 42.3822 73.1445Z"
                    fill="#9CA3AF"
                  />
                  <path
                    d="M38.4173 4.97656C40.295 4.97656 42.0005 5.74321 43.2357 6.98022C44.4708 8.21723 45.2393 9.92274 45.2393 11.7986V14.9874C45.2393 16.8652 44.4727 18.5707 43.2357 19.8058C41.9987 21.0429 40.2932 21.8095 38.4173 21.8095C36.5395 21.8095 34.834 21.0429 33.5989 19.8058C32.3619 18.5707 31.5952 16.8633 31.5952 14.9874V11.7986C31.5952 9.92089 32.3619 8.21538 33.5989 6.98022C34.8359 5.74321 36.5414 4.97656 38.4173 4.97656Z"
                    fill="#F3F4F6"
                  />
                  <path
                    d="M34.6989 22.3467C37.3081 22.6041 39.3673 22.3374 40.9303 21.893C41.4858 21.7356 41.9802 21.5541 42.4136 21.3671V20.6652V20.5078C42.3598 20.5467 42.3043 20.5856 42.2487 20.6245C41.7765 20.9467 41.2636 21.2115 40.7173 21.4078C39.9988 21.667 39.2229 21.8078 38.4173 21.8078C37.6118 21.8078 36.8378 21.667 36.1174 21.4078C35.5711 21.2115 35.0582 20.9467 34.586 20.6245C34.5304 20.5874 34.4748 20.5486 34.4211 20.5078V20.6652V22.3189C34.5156 22.3281 34.6063 22.3393 34.6989 22.3467Z"
                    fill="#E8E8EA"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M23.1882 26.5096V32.6835H29.3714V21.9375L26.9789 22.5412C25.9363 22.8041 24.9512 23.269 24.2512 23.9708C23.5956 24.6245 23.1882 25.4633 23.1882 26.5096Z"
                    fill="#C5C9D0"
                  />
                  <path
                    d="M23.1882 32.6875V44.0521C23.1882 45.152 23.6382 46.1502 24.3623 46.8742C25.0863 47.5983 26.0863 48.0483 27.1844 48.0483H28.1696H28.8603H29.1548H29.3696V41.9132V32.6875H23.1882Z"
                    fill="#F3F4F6"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M53.6485 26.5096V32.6835H47.4653V21.9375L49.8579 22.5412C50.9004 22.8041 51.8856 23.269 52.5856 23.9708C53.2411 24.6245 53.6485 25.4633 53.6485 26.5096Z"
                    fill="#C5C9D0"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M53.6485 26.5125V32.6864H47.4653V26.1551C49.2783 25.3847 51.2226 24.9273 53.2245 24.8125C53.4948 25.3069 53.6485 25.8699 53.6485 26.5125Z"
                    fill="#B5B8BE"
                  />
                  <path
                    d="M53.6486 32.6875V44.0521C53.6486 45.152 53.1986 46.1502 52.4746 46.8742C51.7505 47.5983 50.7505 48.0483 49.6524 48.0483H48.6673H47.9765H47.6821H47.4673V41.9132V32.6875H53.6486Z"
                    fill="#F9C5B8"
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M31.5952 12.6208C32.5767 11.5227 34.6488 10.6246 39.0043 12.0931C41.6913 12.9986 43.7246 13.369 45.2393 13.4653V11.7986C45.2393 9.92089 44.4727 8.21538 43.2357 6.98022C41.9987 5.74506 40.2932 4.97656 38.4173 4.97656C36.6988 4.97656 35.1229 5.62099 33.9211 6.67837C33.81 6.77652 33.7026 6.87652 33.5989 6.98022C32.3637 8.21723 31.5952 9.92274 31.5952 11.7986V12.6208Z"
                    fill="#9CA3AF"
                  />
                  <path
                    d="M70.0006 42.1403C70.0006 50.8391 62.9465 57.8899 54.2485 57.8899C45.5506 57.8899 38.5015 50.8391 38.5015 42.1403C38.5015 33.4414 45.5506 26.3906 54.2485 26.3906C62.9465 26.3906 70.0006 33.4414 70.0006 42.1403Z"
                    fill="#DDE1E8"
                  />
                  <path
                    d="M70.0009 42.1392C70.0009 50.838 62.9468 57.8888 54.2488 57.8888C49.1259 57.8888 44.5777 55.4444 41.7036 51.6595C44.4389 53.7433 47.7842 54.8697 51.2234 54.8649C59.9214 54.8649 66.9755 47.8141 66.9755 39.1152C66.9755 35.5369 65.7805 32.2358 63.7686 29.5898C67.5554 32.4676 70.0009 37.0186 70.0009 42.1392Z"
                    fill="#C9CFD8"
                  />
                  <path
                    d="M65.8811 31.5263C63.0826 28.9862 59.3715 27.4339 55.2923 27.4339C46.5943 27.4339 39.5452 34.4847 39.5452 43.1835C39.5452 47.2759 41.1033 51.0004 43.6597 53.7975C40.4932 50.9197 38.5015 46.7618 38.5015 42.1403C38.5015 33.4414 45.5506 26.3906 54.2485 26.3906C58.8572 26.3906 63.0019 28.3713 65.8811 31.5263Z"
                    fill="#EEF2FB"
                  />
                  <path
                    d="M62.9233 32.8412L56.8726 38.889C56.177 39.5837 55.2339 39.9739 54.2506 39.9739C53.2673 39.9739 52.3242 39.5837 51.6286 38.889L45.5779 32.8412C47.852 30.7144 50.9025 29.4141 54.2506 29.4141C57.5936 29.4141 60.6493 30.7144 62.9233 32.8412Z"
                    fill="#E8EBF1"
                  />
                  <path
                    d="M62.9214 32.8412L62.8457 32.9168C60.64 31.238 57.9438 30.3297 55.1714 30.3313C51.8233 30.3313 48.7727 31.6316 46.4987 33.7584L51.6267 38.889L45.5759 32.8412C47.85 30.7144 50.9006 29.4141 54.2487 29.4141C57.5917 29.4141 60.6473 30.7144 62.9214 32.8412Z"
                    fill="#EEF2FB"
                  />
                  <mask
                    id="mask0_3886_2587"
                  ...
                  >
                    <path
                      d="M54.2507 29.9141C57.2764 29.9141 60.056 31.0236 62.1951 32.8613L56.5193 38.5352C55.9175 39.1362 55.1015 39.4736 54.2507 39.4736C53.3999 39.4736 52.584 39.1361 51.9822 38.5352L46.3054 32.8613C48.4442 31.0233 51.2202 29.9141 54.2507 29.9141Z"
                      fill="#CBDFED"
                      stroke="#C9CFD8"
                    />
                  </mask>
                  <g mask="url(#mask0_3886_2587)">
                    <path
                      d="M60.5997 31.1797L59.6479 32.7571"
                      stroke="#9CA2AA"
                      strokeWidth="0.7"
                      strokeLinecap="round"
                    />
                    <path
                      d="M57.5674 29.8883L57.0682 31.6615"
                      stroke="#9CA2AA"
                      strokeWidth="0.7"
                      strokeLinecap="round"
                    />
                    <path
                      d="M54.2451 29.4643L54.2483 31.3063"
                      stroke="#9CA2AA"
                      strokeWidth="0.7"
                      strokeLinecap="round"
                    />
                    <path
                      d="M50.9521 29.8948L51.4659 31.6638"
                      stroke="#9CA2AA"
                      strokeWidth="0.7"
                      strokeLinecap="round"
                    />
                    <path
                      d="M47.9145 31.1849L48.8424 32.7764"
                      stroke="#9CA2AA"
                      strokeWidth="0.7"
                      strokeLinecap="round"
                    />
                ...
                <defs>
                  <clipPath id="clip0_3886_2587">
                    <rect
                      ...
                      height="80"
                      fill="white"
                      transform="translate(0.164062 0.339844)"
                    />
                  </clipPath>
                </defs>
              </svg>
              ...
              <Button
                onClick={() => setShowPhisicalAssessment(true)}
                variant="outline"
                disabled={false}
                contentSize="medium"
              >
                            ...
                            <div className="phisical-assessment-accordion-showData-box d-flex gap-3">
                              ...
                              >
                                ...
                                <g clipPath="url(#clip0_7367_20111)">
                                  <path
                                    d="M19.6268 9.35156H13.1858V33.5087H19.6268V9.35156Z"
                                    stroke="#3E5A91"
                                    strokeWidth="1.66213"
                                    strokeMiterlimit="10"
                                    strokeLinecap="round"
                                  ...
                                  />
                                  <path
                                    d="M16.1631 18.5391H19.6417"
                                    stroke="#3E5A91"
                                    strokeWidth="0.831064"
                                    strokeMiterlimit="10"
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
                                  />
                                  <path
                                    d="M16.1631 23.5391H19.6417"
                                    stroke="#3E5A91"
                                    strokeWidth="0.831064"
                                    strokeMiterlimit="10"
                                    strokeLinecap="round"
                                ...
                                <defs>
                                  <clipPath id="clip0_7367_20111">
                                    <rect
                                      ...
                                      height="27.1765"
                                      fill="white"
                                      transform="translate(7.52124 7.75)"
                                    />
                                  </clipPath>
                                </defs>
                              </svg>
                              ...
                              <div className="d-flex flex-column gap-1">
                                ...
                                <span className="phisical-assessment-accordion-showData-box-subtitle">
                                  ...
                                  {convertHeightToCm(item.height) && (
                                    <span>
                                      {" "}
                                      ({convertHeightToCm(item.height)} cm)
                                    </span>
                                  )}
                                </span>
                              </div>
                          ...
                          <Col md={4} sm={6}>
                            <div className="phisical-assessment-accordion-showData-box d-flex gap-3">
                              ...
                              >
                                ...
                                />
                                <path
                                  d="M9.85962 8.21484H32.3596C33.3596 8.21484 34.2346 9.08984 34.2346 10.0898V32.5898C34.2346 33.5898 33.3596 34.4648 32.3596 34.4648H9.85962C8.85962 34.4648 7.98462 33.5898 7.98462 32.5898V10.0898C7.98462 9.08984 8.85962 8.21484 9.85962 8.21484Z"
                                  stroke="#F4C47E"
                                  strokeWidth="0.934397"
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
                                />
                                <path
                                  d="M18.9846 17.3398L17.9846 15.0898M28.6096 15.0898C24.4846 10.9648 17.7346 10.9648 13.6096 15.0898L17.1096 18.5898C19.3596 16.3398 22.8596 16.3398 25.1096 18.5898L28.6096 15.0898Z"
                                  stroke="#F4C47E"
                                  strokeWidth="0.934397"
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
                          ...
                          <Col md={4} sm={6}>
                            <div className="phisical-assessment-accordion-showData-box d-flex gap-3">
                              ...
                              >
                                ...
                                />
                                <path
                                  d="M21.7724 8.48956C21.6854 8.40247 21.5821 8.33338 21.4684 8.28624C21.3546 8.23911 21.2327 8.21484 21.1096 8.21484C20.9865 8.21484 20.8646 8.23911 20.7509 8.28624C20.6371 8.33338 20.5338 8.40247 20.4468 8.48956C20.0911 8.84478 11.7346 17.2914 11.7346 25.0899C11.7346 27.5763 12.7223 29.9608 14.4805 31.719C16.2386 33.4772 18.6232 34.4649 21.1096 34.4649C23.596 34.4649 25.9806 33.4772 27.7387 31.719C29.4969 29.9608 30.4846 27.5763 30.4846 25.0899C30.4846 17.2914 22.1281 8.84478 21.7724 8.48956ZM21.1096 32.5899C19.1212 32.5876 17.2149 31.7967 15.8088 30.3907C14.4028 28.9846 13.6119 27.0783 13.6096 25.0899C13.6096 19.2699 19.1641 12.657 21.1096 10.5202C23.0561 12.6561 28.6096 19.2616 28.6096 25.0899C28.6073 27.0783 27.8164 28.9846 26.4104 30.3907C25.0044 31.7967 23.098 32.5876 21.1096 32.5899Z"
                                  fill="#F12647"
                                  fillOpacity="0.7"
                                />
                                <path
                                  d="M23.9221 24.1523H22.0471V22.2773C22.0471 22.0287 21.9483 21.7902 21.7725 21.6144C21.5967 21.4386 21.3583 21.3398 21.1096 21.3398C20.861 21.3398 20.6225 21.4386 20.4467 21.6144C20.2709 21.7902 20.1721 22.0287 20.1721 22.2773V24.1523H18.2971C18.0485 24.1523 17.81 24.2511 17.6342 24.4269C17.4584 24.6027 17.3596 24.8412 17.3596 25.0898C17.3596 25.3385 17.4584 25.5769 17.6342 25.7528C17.81 25.9286 18.0485 26.0273 18.2971 26.0273H20.1721V27.9023C20.1721 28.151 20.2709 28.3894 20.4467 28.5653C20.6225 28.7411 20.861 28.8398 21.1096 28.8398C21.3583 28.8398 21.5967 28.7411 21.7725 28.5653C21.9483 28.3894 22.0471 28.151 22.0471 27.9023V26.0273H23.9221C24.1708 26.0273 24.4092 25.9286 24.585 25.7528C24.7608 25.5769 24.8596 25.3385 24.8596 25.0898C24.8596 24.8412 24.7608 24.6027 24.585 24.4269C24.4092 24.2511 24.1708 24.1523 23.9221 24.1523Z"
                                  fill="#F12647"
                                  fillOpacity="0.7"
                                />
                              </svg>
        ...
        <>
          ...
          {Object.keys(modalFormFertilityData).length === 0 ? (
            <div className="text-center">
              ...
              <Button
                onClick={() => setShowFertilityAssessment(true)}
                variant="outline"
                disabled={false}
                contentSize="medium"
              >
                ...
                <Row className="">
                  ...
                  <Col sm={12}>
                    <div className="">
                      ...
                      {medicalHistoryFormData.medicalCondition.map(
                        (item: any) => {
                          return (
                            <p
                              key={item.id}
          ...
          <Accordion className="mb-3" alwaysOpen activeKey={activeAccordion}>
            {accordionData.map((item) => (
              <Accordion.Item
                eventKey={item.id}
                key={item.id}
                className="patient-accordion-item shadow-sm mb-3"
              >
                <Accordion.Header
                  onClick={() =>
