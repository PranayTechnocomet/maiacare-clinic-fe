...
import { EditFertilityAssessment, FertilityAssessmentType, MedicalHistoryType, PhysicalAssessmentDataModel } from '../../utlis/types/interfaces';
            ...
            <form>
                <Row className='g-md-2 g-1'>
                    ...
                    <div className='d-flex gap-3 mt-3'>
                        ...
                        <Button className="w-100" variant="default" disabled={false} type="submit" onClick={(e:FormEvent<HTMLFormElement>)=>handleSubmit(e)}>
                            Save
                        </Button>
                    </div>
