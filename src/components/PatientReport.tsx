                ...
                {patientReportData.map((item, index) => (
                    <Col key={index}>
                        <div className="patient-report-box">
                            ...
                            />
                            <h6 className="patient-report-box-title mt-2 m-0">{item.reportName}</h6>
