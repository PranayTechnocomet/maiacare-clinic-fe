                    ...
                    <ContentContainer>
                        ...
                        {ivfProgressData.map((item, index) => {
                            ...
                            return (
                                ...
                                >
                                    <div
                                        className={`patient-journey-box shadow-sm ms-5 mb-3  ${item.status == "Success"
                                                        ...
                                                        <div className='d-flex justify-content-between align-items-center report-box mb-3' >
                                                            <div className='d-flex gap-2'>
                                                                ...
                                                                <div className='d-flex flex-column'>
                                                                    <span className='patient-treatment-box-subtitle-desc mb-1'>{item.reportName}</span>
                                                                    <span className="select-profile-subtitle">{item.name}</span>
